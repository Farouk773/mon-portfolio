...
const TRANSLATIONS = {
  fr: {
    ...
    about: {
      ...
      cards: [
        { title: "Développement Full-Stack", subtitle: "Applications de bout en bout", description: "Création d'applications React modernes, de composants Blazor et de services backend évolutifs.", icon: "code" },
        { title: "APIs REST & Sécurité", subtitle: "Architecture & Authentification", description: "Conception d'APIs REST sous Spring Boot et ASP.NET Core sécurisées par tokens JWT.", icon: "layers" },
        { title: "Données & Outils IA", subtitle: "Traitement de signal & ML", description: "Nettoyage de fichiers CSV, lissage de signaux, détection d'anomalies et pipelines Pandas.", icon: "terminal" },
        { title: "Design UI/UX", subtitle: "Du croquis au produit", description: "Transformation de besoins bruts et de croquis papier en interfaces utilisateur élégantes et réactives.", icon: "sparkles" }
      ]
    },
    projects: {
  ...
  en: {
    ...
    about: {
      ...
      cards: [
        { title: "Full-Stack Development", subtitle: "End-to-End Applications", description: "Building responsive SPAs, Blazor components, and scalable backend services.", icon: "code" },
        { title: "REST APIs & Security", subtitle: "Microservices & Auth", description: "Designing robust API controllers in Spring Boot and ASP.NET Core with JWT authentication.", icon: "layers" },
        { title: "Data & AI Tools", subtitle: "Signal Analysis & ML", description: "Ingesting telemetry CSV datasets, signal smoothing, anomaly detection, and Pandas pipelines.", icon: "terminal" },
        { title: "UI/UX Design", subtitle: "Wireframes to Production", description: "Transforming raw requirements and hand-drawn paper wireframes into intuitive user interfaces.", icon: "sparkles" }
      ]
    },
    projects: {
...
const FEATURED_PROJECTS = [
  {
    ...
    caseStudy: {
      ...
      screenshots: [
        { title: "Initial Ingestion Setup (Before Pipeline)", src: "/assets/csv-initial.jpg", caption: "Raw CSV log upload screen showing target column selection before running signal filtering." },
        { title: "Completed Signal Pipeline (After Processing)", src: "/assets/csv-completed.jpg", caption: "3-chart output panel displaying Raw vs Smoothed telemetry, Anomaly Spikes, and Trend Evolution." }
      ],
  ...
  },
  {
    ...
    caseStudy: {
      ...
      screenshots: [
        { title: "Main Operations & Action Portal", src: "/assets/maint-screen-1.png", caption: "Overview dashboard displaying active equipment complaint tickets and technician dispatches." },
        { title: "Complaint Registration & Asset Form", src: "/assets/maint-screen-2.png", caption: "Form interface for logging new technical complaints, assigning asset IDs, and prioritizing urgency." },
        { title: "Equipment Inventory & Maintenance Logs", src: "/assets/maint-screen-3.png", caption: "Catalog tracking facility equipment, inspection history, and breakdown recurrence." },
        { title: "Technician Dispatch & Workload Scheduling", src: "/assets/maint-screen-4.png", caption: "Module for assigning repair tickets to technicians based on workload availability." },
        { title: "System Architecture & Access Control Flow", src: "/assets/maint-screen-5.png", caption: "Data architecture diagram mapping Blazor WASM components to ASP.NET Core REST APIs." }
      ],
  ...
  },
  {
    ...
    caseStudy: {
      ...
      keyFeatures: [
        ...
        "Modal dialogs for inline entity updates (e.g. Add/Edit Course)",
      ...
      screenshots: [
        { title: "Main Portal Landing View", src: "/assets/olp-screen-1.jpg", caption: "Main academic platform header with navigation links and platform statistics." },
        { title: "Course Catalog Grid", src: "/assets/olp-screen-2.jpg", caption: "Interactive grid displaying courses categorized by topic and difficulty." },
        { title: "Add/Edit Course Modal", src: "/assets/olp-screen-3.jpg", caption: "Modal popup interface for creating and modifying academic course details." },
        { title: "Student Management & Enrollment", src: "/assets/olp-screen-4.jpg", caption: "Table interface listing registered students and active course enrollments." },
        { title: "Course Details & Syllabus View", src: "/assets/olp-screen-5.jpg", caption: "Detailed view of selected course syllabus, instructor bio, and materials." },
        { title: "Authentication & Login Portal", src: "/assets/olp-screen-6.jpg", caption: "Secure student and instructor portal login interface." },
        { title: "Paper Wireframe Sketch #1", src: "/assets/olp-screen-7.jpg", caption: "Hand-drawn paper wireframe mapping main navigation and course layout." },
        { title: "Paper Wireframe Sketch #2", src: "/assets/olp-screen-8.jpg", caption: "Initial wireframe layout for course cards and action buttons." },
        { title: "Paper Wireframe Sketch #3", src: "/assets/olp-screen-9.jpg", caption: "Wireframe concept for modal dialogs and student registration forms." },
        { title: "Paper Wireframe Sketch #4", src: "/assets/olp-screen-10.jpg", caption: "Wireframe layout for student profile and enrollment tables." },
        { title: "Paper Wireframe Sketch #5", src: "/assets/olp-screen-11.jpg", caption: "Final wireframe layout for mobile responsiveness." }
      ],
  ...
  },
  {
    ...
    caseStudy: {
      ...
      screenshots: [
        { title: "HackJourney Home Landing Page (01_accueil)", src: "/assets/hackjourney-1.png", caption: "Main welcome portal for HackJourney hackathon discovery, active challenges, and event registration." },
        { title: "Hackathon Login & Authentication (02_connexion_hackathon)", src: "/assets/hackjourney-2.png", caption: "Secure user login screen supporting Organizers, Participants, Jury, and Mentors." },
        { title: "Hackathon Registration & Team Onboarding (03_inscription_hackathon)", src: "/assets/hackjourney-3.png", caption: "Participant sign-up wizard for creating profile tags, listing skills, and joining hackathon teams." }
      ],
...
const EDUCATION = [
  { school: "CY Tech", location: "3 rue Lebon, Cergy, France", degree: "Engineering Degree in Computer Science", period: "Starting 2026 — 1st Year Engineering Cycle", description: "Entering CY Tech engineering cycle in 2026 with emphasis on software engineering, backend architectures, database design, and data engineering." },
  { school: "3iL", location: "Limoges, France", degree: "1st Year Engineering Cycle in Computer Science", period: "2024–2025", description: "Foundational CS cycle covering object-oriented design, web engineering, and databases." },
  { school: "IIT", location: "Sfax, Tunisia", degree: "Higher Technician Degree in Computer Engineering", period: "2022–2025", description: "Engineering technician program focusing on software development, network & DB administration." },
  { school: "Baccalaureate", location: "Tunisia", degree: "Baccalaureate in Mathematics", period: "2022", description: "Rigorous scientific baccalaureate with emphasis on advanced mathematics and physics." }
];
...
const Icon = ({ name, className = "w-4 h-4" }) => {
  const icons = {
    ...
    fileText: <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2zM14 2v6h6"/>,
    ...
    layers: <g><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 12.5-8.58 3.91a2 2 0 0 1-1.66 0L3 12.5"/><path d="m22 17.5-8.58 3.91a2 2 0 0 1-1.66 0L3 17.5"/></g>,
...
// -------------------------------------------------------------
function Navbar({ activeSection, onOpenContact, onOpenCV }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled ? 'bg-[#0b0f19]/90 backdrop-blur-xl border-b border-slate-800/80 py-3 shadow-2xl' : 'bg-transparent py-5 sm:py-6'
    }`}>
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between gap-4">
          ...
          <a href="#home" className="flex items-center gap-3 group flex-shrink-0">
            <img src={PROFILE_DATA.avatar} alt="Farouk BOURAOUI" className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl object-cover border border-cyan-400/50 shadow-md group-hover:scale-105 transition-transform" />
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] sm:text-xs font-medium text-slate-400">{t.nav.cyTechStudent}</span>
              </div>
            </div>
          </a>

          {/* Navigation Links Pill */}
          <nav className="hidden xl:flex items-center gap-1 bg-slate-900/80 p-1.5 rounded-full border border-slate-800/90 backdrop-blur-md shadow-lg">
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all ${
                    isActive ? 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-md' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'
                  }`}
                >
                  {link.label}
                </a>
          ...
          <div className="hidden lg:flex items-center gap-3.5 flex-shrink-0">
            ...
            >
              <Icon name="globe" className="w-4 h-4 text-cyan-400 group-hover:rotate-12 transition-transform" />
              <div className="flex items-center gap-1 text-[11px]">
                <span className={lang === 'fr' ? 'text-cyan-300 font-black' : 'text-slate-500 font-semibold'}>FR</span>
                <span className="text-slate-600 text-[10px]">/</span>
                <span className={lang === 'en' ? 'text-cyan-300 font-black' : 'text-slate-500 font-semibold'}>EN</span>
              </div>
            </button>

            <a href={PROFILE_DATA.github} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-cyan-400 hover:border-cyan-500/40 transition-all">
              <Icon name="github" />
            </a>
            <a href={PROFILE_DATA.linkedin} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-cyan-400 hover:border-cyan-500/40 transition-all">
              <Icon name="linkedin" />
            </a>

            <button onClick={onOpenContact} className="btn-primary px-4 py-2.5 rounded-xl text-xs font-extrabold flex items-center gap-2 shadow-lg shadow-cyan-500/20">
              <Icon name="send" className="w-3.5 h-3.5" />
              <span>{t.nav.workTogether}</span>
            </button>
          </div>
          ...
          <div className="flex xl:hidden items-center gap-2.5">
            ...
            >
              <Icon name="globe" className="w-3.5 h-3.5 text-cyan-400" />
              <span>{lang.toUpperCase()}</span>
            </button>

            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-200">
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="xl:hidden bg-[#0b0f19]/95 backdrop-blur-2xl border-b border-slate-800 px-6 py-6 space-y-4 shadow-2xl">
          ...
          <div className="pt-4 border-t border-slate-800 flex flex-col gap-3">
            <button onClick={() => { setMobileMenuOpen(false); onOpenContact(); }} className="w-full btn-primary py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/30 shadow-lg">
            ...
            {/* Main Headline with Profile Photo Avatar */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <div className="relative group flex-shrink-0">
                ...
                />
                <div className="absolute -bottom-2 -right-2 px-2 py-0.5 bg-cyan-500 text-slate-950 font-bold text-[10px] rounded-md shadow-md">
                  CY Tech '26
                </div>
              </div>
              ...
              <div className="space-y-2">
                <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight leading-[1.1]">
                  {t.hero.titlePrefix} <span className="text-gradient-cyan">{t.hero.titleGradient}</span>
                </h1>
            ...
            <div className="space-y-3 text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl font-normal">
              <p>{t.hero.intro}</p>
              <p className="text-slate-400">{t.hero.secondaryIntro}</p>
            </div>

            <div className="pt-2 flex flex-wrap items-center gap-4">
              <a href="#projects" className="btn-primary px-6 py-3.5 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-cyan-500/25">
                <span>{t.hero.viewProjects}</span>
                <Icon name="arrowRight" className="w-4 h-4" />
              </a>

              <a href={PROFILE_DATA.cvPdf} download="Farouk_Bouraoui_CV.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary px-6 py-3.5 rounded-xl font-bold text-sm flex items-center gap-2 border border-slate-700">
            ...
            <div className="pt-4 border-t border-slate-800/80">
              ...
              <div className="flex flex-wrap gap-2">
                {heroTechs.map((tech) => (
                  <span key={tech.name} className={`px-3 py-1.5 rounded-lg text-xs font-semibold border bg-gradient-to-r ${tech.color}`}>
                    {tech.name}
                  </span>
                ))}
              </div>
            ...
            <div className="mockup-window glass-panel border border-slate-800 shadow-2xl relative">
              <div className="mockup-header">
                ...
                <div className="flex items-center gap-1 bg-slate-900/80 p-1 rounded-lg border border-slate-800 text-[11px] font-mono">
                  <button onClick={() => setActiveTab('code')} className={`px-2.5 py-1 rounded ${activeTab === 'code' ? 'bg-cyan-500/20 text-cyan-300 font-semibold' : 'text-slate-400'}`}>farouk.ts</button>
                  <button onClick={() => setActiveTab('arch')} className={`px-2.5 py-1 rounded ${activeTab === 'arch' ? 'bg-cyan-500/20 text-cyan-300 font-semibold' : 'text-slate-400'}`}>arch.puml</button>
                  <button onClick={() => setActiveTab('terminal')} className={`px-2.5 py-1 rounded ${activeTab === 'terminal' ? 'bg-cyan-500/20 text-cyan-300 font-semibold' : 'text-slate-400'}`}>terminal</button>
                </div>
              </div>
              ...
              <div className="p-5 font-mono text-xs leading-relaxed overflow-x-auto min-h-[340px] bg-[#0c1220]/90">
                {activeTab === 'code' && (
                  <div className="space-y-1 text-slate-300">
                    ...
                    <p className="pl-4"><span className="text-cyan-400">academicStart</span>: <span className="text-emerald-300">'2026 (1st Year Eng. Cycle)'</span>;</p>
                    <p className="pl-4"><span className="text-cyan-400">email</span>: <span className="text-emerald-300">'faroukbouraoui9@gmail.com'</span>;</p>
                    <p className="pl-4"><span className="text-cyan-400">location</span>: <span className="text-emerald-300">'3 rue Lebon, Cergy, France'</span>;</p>
                    ...
                    <p className="pl-8"><span className="text-cyan-300">frontend</span>: [<span className="text-emerald-300">'React'</span>, <span className="text-emerald-300">'Blazor'</span>],</p>
                  ...
                  <div className="space-y-3 text-slate-300">
                    <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-center text-[10px] pt-1">
                        <div className="p-2 rounded bg-cyan-950/60 border border-cyan-800/50 text-cyan-300">Client Apps<br/><span className="text-slate-400">React / Blazor</span></div>
                        <div className="p-2 rounded bg-indigo-950/60 border border-indigo-800/50 text-indigo-300">REST Gateway<br/><span className="text-slate-400">JWT Auth</span></div>
                        <div className="p-2 rounded bg-emerald-950/60 border border-emerald-800/50 text-emerald-300">Backend Core<br/><span className="text-slate-400">Spring / .NET</span></div>
                      </div>
                    </div>
                  </div>
                )}
                {activeTab === 'terminal' && (
                  <div className="space-y-1.5 text-slate-300">
                    ...
                    <p className="text-yellow-400">Address: 3 rue Lebon, Cergy, France</p>
                    <p className="text-yellow-400">Email: faroukbouraoui9@gmail.com</p>
                    <p className="text-yellow-400">Academic Start: CY Tech (2026)</p>
  ...
  return (
    <section id="about" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel glass-panel-hover p-8 rounded-2xl border border-slate-800 space-y-4 text-slate-300 leading-relaxed mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {t.about.cards.map((card, idx) => (
            <div key={idx} className="glass-panel glass-panel-hover p-6 rounded-2xl border border-slate-800 space-y-3">
              <div className="w-10 h-10 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-400">
                <Icon name={card.icon} className="w-5 h-5" />
              </div>
              <span className="text-xs font-semibold text-cyan-400 uppercase tracking-wider block">{card.subtitle}</span>
...
function CaseStudyModal({ project, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 modal-backdrop overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-[#0d1322] border border-slate-700 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col my-auto">
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-8 text-slate-300 text-sm leading-relaxed">
          <div className="space-y-2">
            ...
            <p className="text-slate-300 text-base">{cs.overview || project.shortDescription}</p>
            <div className="flex flex-wrap gap-2 pt-2">
              {project.technologies.map(tech => <span key={tech} className="badge-tech">{tech}</span>)}
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-panel p-5 rounded-xl border-l-4 border-l-amber-500 space-y-2">
              <h3 className="text-sm font-bold text-white">{t.modal.problem}</h3>
              <p className="text-xs text-slate-300">{cs.problem}</p>
            </div>
            <div className="glass-panel p-5 rounded-xl border-l-4 border-l-cyan-500 space-y-2">
              <h3 className="text-sm font-bold text-white">{t.modal.role}</h3>
              <p className="text-xs text-slate-300">{cs.role}</p>
            </div>
          </div>

          {cs.wireframeStory && (
            <div className="glass-panel p-6 rounded-2xl space-y-4 border border-cyan-500/30">
              <h3 className="text-lg font-bold text-white">{cs.wireframeStory.title}</h3>
              <p className="text-xs text-slate-300">{cs.wireframeStory.description}</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <span className="text-xs font-bold text-amber-400 block mb-1">Hand-Drawn Wireframe</span>
                  <img src={cs.wireframeStory.wireframeImage} alt="Wireframe" className="rounded-lg w-full h-40 object-cover border border-slate-800" />
                </div>
                <div>
                  <span className="text-xs font-bold text-emerald-400 block mb-1">Final Web Interface</span>
                  <img src={cs.wireframeStory.finalImage} alt="Final UI" className="rounded-lg w-full h-40 object-cover border border-slate-800" />
                </div>
              </div>
            </div>
          )}
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-white">{t.modal.solution}</h3>
            <p className="text-xs text-slate-300">{cs.solution}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {cs.keyFeatures && cs.keyFeatures.map((f, i) => (
          ...
          {cs.screenshots && cs.screenshots.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-base font-bold text-white">{t.modal.screenshots}</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {cs.screenshots.map((s, idx) => (
                  <div key={idx} className="mockup-window glass-panel">
                    <div className="mockup-header"><span className="text-[10px] text-slate-400">{s.title}</span></div>
                    <img src={s.src} alt={s.title} className="w-full h-48 object-cover" />
                    <div className="p-2 text-[10px] text-slate-400 bg-slate-900 border-t border-slate-800">{s.caption}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="px-6 py-4 bg-[#141c2e] border-t border-slate-800 flex justify-between items-center">
          <span className="text-xs text-slate-400">{t.modal.category} {project.category}</span>
          <button onClick={onClose} className="btn-primary px-4 py-2 rounded-xl text-xs font-bold">{t.modal.close}</button>
        </div>
...
function Projects() {
  ...
  const categories = [
    ...
    { id: 'Client Work', label: t.projects.catClient },
    { id: 'Full-Stack', label: t.projects.catFullstack },
    { id: 'Data & AI', label: t.projects.catData },
    { id: 'UI/UX Design', label: t.projects.catUi }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                activeCategory === cat.id ? 'bg-cyan-500 text-white shadow-lg' : 'bg-slate-900 text-slate-300 border border-slate-800'
              }`}
            >
              {cat.label}
            </button>
        ...
        <div className="space-y-12 mb-20">
          {filteredProjects.map((project) => (
            <div key={project.id} className="glass-panel glass-panel-hover rounded-2xl p-6 sm:p-8 border border-slate-800 group">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                
                <div className="lg:col-span-6 space-y-4">
                  <div className="flex gap-2">
                    <span className="badge-category">{project.category}</span>
                    <span className="text-[11px] font-semibold text-slate-400 bg-slate-800 px-2.5 py-0.5 rounded-full">{project.badge}</span>
                  </div>
                  ...
                  <div className="pt-2 flex items-center gap-3">
                    <button onClick={() => setActiveCaseStudy(project)} className="btn-primary px-5 py-2.5 rounded-xl text-xs font-bold flex items-center gap-2">
                      <span>{t.projects.viewCaseStudy}</span>
                      <Icon name="arrowRight" className="w-3.5 h-3.5" />
                    </button>
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noopener noreferrer" className="btn-secondary px-4 py-2.5 rounded-xl text-xs font-semibold flex items-center gap-2">
                ...
                <div className="lg:col-span-6">
                  <div className="mockup-window glass-panel overflow-hidden border border-slate-700 shadow-2xl">
                    <div className="mockup-header"><span className="text-[11px] font-mono text-slate-400">{project.title.toLowerCase().replace(/\s+/g, '-')}.app</span></div>
                    <img src={project.primaryImage} alt={project.title} className="w-full h-64 object-cover cursor-pointer" onClick={() => setActiveCaseStudy(project)} />
                  </div>
                </div>
        ...
        <div className="pt-8 border-t border-slate-800">
          <h3 className="text-xl font-bold text-white mb-6">{t.projects.otherTitle}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {OTHER_PROJECTS.map((proj, idx) => (
              <div key={idx} className="glass-panel glass-panel-hover p-6 rounded-2xl border border-slate-800 space-y-3">
                <span className="text-[11px] font-semibold text-cyan-400 uppercase tracking-wider block">{proj.category}</span>
                <h4 className="text-base font-bold text-white">{proj.title}</h4>
                <p className="text-slate-400 text-xs">{proj.description}</p>
                <div className="pt-2 flex flex-wrap gap-1">
                  {proj.technologies.map(t => <span key={t} className="text-[10px] px-2 py-0.5 bg-slate-900 text-slate-300 rounded border border-slate-800">{t}</span>)}
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          {EXPERIENCES.map((exp, idx) => (
            <div key={idx} className="glass-panel glass-panel-hover p-7 rounded-2xl border border-slate-800 space-y-4">
              ...
              <div>
                ...
                <span className="text-cyan-400 font-semibold text-sm">@ {exp.company}{exp.location ? ` — ${exp.location}` : ''}</span>
              </div>

              <p className="text-slate-300 text-xs sm:text-sm">{exp.description}</p>

              <div className="space-y-1.5 pt-1">
                {exp.highlights.map((item, i) => (
                  <div key={i} className="flex items-center gap-2 text-xs text-slate-300">
                    <Icon name="check" className="w-3.5 h-3.5 text-cyan-400 flex-shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-3 border-t border-slate-800 flex flex-wrap gap-1.5">
                {exp.technologies.map(tech => <span key={tech} className="badge-tech">{tech}</span>)}
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SKILL_CATEGORIES.map((cat, idx) => (
            <div key={idx} className="glass-panel glass-panel-hover p-6 rounded-2xl border border-slate-800 space-y-4">
              <h3 className="text-lg font-bold text-white border-b border-slate-800 pb-2">{cat.name}</h3>
              <div className="flex flex-wrap gap-2">
                {cat.skills.map(skill => (
                  <span key={skill} className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-slate-900 text-slate-200 border border-slate-800">
                    {skill}
                  </span>
                ))}
              </div>
...
function Education() {
  ...
  const LANGUAGES = [
    { name: t.education.fr, level: t.education.c1, percentage: 95 },
    { name: t.education.ar, level: t.education.native, percentage: 100 },
    { name: t.education.en, level: t.education.b1, percentage: 65 }
  ];
  ...
  return (
    <section id="education" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="section-badge">{t.education.badge}</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
            {t.education.title}
          </h2>
          <p className="text-slate-400 text-base">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8 space-y-4">
            {EDUCATION.map((edu, idx) => (
              <div key={idx} className="glass-panel glass-panel-hover p-6 rounded-2xl border border-slate-800 space-y-2">
                <div className="flex justify-between items-center">
                  <h4 className="text-lg font-bold text-white">{edu.school} — {edu.location}</h4>
                  <span className="px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs font-semibold">{edu.period}</span>
                </div>
                <div className="text-sm font-bold text-slate-200">{edu.degree}</div>
                <p className="text-slate-400 text-xs">{edu.description}</p>
              </div>
            ))}
          </div>
            ...
            {LANGUAGES.map((lang, idx) => (
              <div key={idx} className="space-y-1.5">
                ...
                <div className="w-full h-2 rounded-full bg-slate-900 overflow-hidden border border-slate-800">
                  <div className="h-full rounded-full bg-gradient-to-r from-cyan-500 to-indigo-500" style={{ width: `${lang.percentage}%` }}></div>
                </div>
              </div>
            ))}
          </div>
...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    setTimeout(() => { setLoading(false); setSubmitted(true); setFormData({ name: '', email: '', subject: '', message: '' }); }, 600);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto">
          <div className="lg:col-span-5 glass-panel p-6 rounded-2xl border border-slate-800 space-y-6">
            <h3 className="text-xl font-bold text-white">{t.contact.sideTitle}</h3>
            <div className="space-y-4">
              <a href={`mailto:${PROFILE_DATA.email}`} className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center gap-4 hover:border-cyan-500/50">
                <Icon name="mail" className="w-5 h-5 text-cyan-400" />
                <div>
                  <span className="text-[11px] text-slate-400 block">{t.contact.directEmail}</span>
                  <span className="text-sm font-bold text-white">{PROFILE_DATA.email}</span>
                </div>
              </a>
              <a href={PROFILE_DATA.linkedin} target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center gap-4 hover:border-cyan-500/50">
                <Icon name="linkedin" className="w-5 h-5 text-cyan-400" />
                <div>
                  <span className="text-[11px] text-slate-400 block">{t.contact.linkedin}</span>
                  <span className="text-sm font-bold text-white">linkedin.com/in/farouk-bouraoui-a4a24a2b9</span>
                </div>
              </a>
              <a href={PROFILE_DATA.github} target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center gap-4 hover:border-cyan-500/50">
                <Icon name="github" className="w-5 h-5 text-cyan-400" />
                <div>
                  <span className="text-[11px] text-slate-400 block">{t.contact.github}</span>
                  <span className="text-sm font-bold text-white">github.com/faroukbouraoui</span>
                </div>
              </a>
              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center gap-4">
                ...
                <div>
                  <span className="text-[11px] text-slate-400 block">{t.contact.address}</span>
                  <span className="text-sm font-bold text-white">{PROFILE_DATA.address}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 glass-panel p-6 sm:p-8 rounded-2xl border border-slate-800">
            {submitted ? (
              <div className="py-12 text-center space-y-3">
                ...
                <p className="text-slate-300 text-xs">{t.contact.successSub}</p>
                <button onClick={() => setSubmitted(false)} className="btn-secondary px-4 py-2 rounded-xl text-xs">{t.contact.anotherMessage}</button>
              </div>
            ) : (
...
function CVModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-backdrop overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-[#0d1322] border border-slate-700 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col my-auto">
        <div className="flex items-center justify-between px-6 py-4 bg-[#141c2e] border-b border-slate-800">
          <span className="text-white font-bold text-sm">{t.cvModal.title}</span>
          <div className="flex items-center gap-3">
            <a href={PROFILE_DATA.cvPdf} download="Farouk_Bouraoui_CV.pdf" target="_blank" rel="noopener noreferrer" className="btn-primary px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1.5">
              <Icon name="download" className="w-3.5 h-3.5" />
              <span>{t.cvModal.download}</span>
            </a>
            <button onClick={() => window.print()} className="btn-secondary px-3 py-1.5 rounded-lg text-xs font-bold">{t.cvModal.print}</button>
            <button onClick={onClose} className="p-1 text-slate-400 hover:text-white"><Icon name="x" className="w-5 h-5" /></button>
          </div>
        </div>
        <div className="p-6 overflow-y-auto space-y-6 text-slate-300 text-xs">
          <div className="border-b border-slate-800 pb-4 flex items-center gap-4">
            <img src={PROFILE_DATA.avatar} alt="Farouk BOURAOUI" className="w-16 h-16 rounded-xl object-cover border border-cyan-400/50" />
            <div>
              <h1 className="text-xl font-extrabold text-white">Farouk BOURAOUI</h1>
              <p className="text-cyan-400 font-bold">Full-Stack Developer | Software Engineering Student</p>
              <p className="text-slate-400 mt-1">{PROFILE_DATA.address} • {PROFILE_DATA.email}</p>
            </div>
          </div>
          <div className="space-y-2">
            <h2 className="font-bold text-cyan-400 uppercase">{t.cvModal.summaryTitle}</h2>
            <p>{t.hero.intro} {t.hero.secondaryIntro}</p>
          </div>
          <div className="space-y-3">
            <h2 className="font-bold text-cyan-400 uppercase">{t.cvModal.expTitle}</h2>
            {EXPERIENCES.map((exp, idx) => (
              <div key={idx} className="p-3 bg-slate-900 rounded-lg border border-slate-800">
                <span className="font-bold text-white block">{exp.role} @ {exp.company}{exp.location ? ` (${exp.location})` : ''} ({exp.period})</span>
                <p className="text-slate-400">{exp.description}</p>
              </div>
            ))}
          </div>
          <div className="space-y-3">
            <h2 className="font-bold text-cyan-400 uppercase">{t.cvModal.eduTitle}</h2>
            {EDUCATION.map((edu, idx) => (
              <div key={idx} className="p-3 bg-slate-900 rounded-lg border border-slate-800">
                <span className="font-bold text-white block">{edu.school} — {edu.degree} ({edu.period})</span>
                <span className="text-slate-400 block">{edu.location}</span>
              </div>
            ))}
          </div>
        </div>
...
function Footer() {
  ...
  return (
    <footer className="bg-[#080b13] border-t border-slate-800 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-xs text-slate-500 space-y-4">
        <div className="flex justify-center gap-6 text-slate-400 font-semibold">
          <a href="#projects" className="hover:text-cyan-400">{t.nav.projects}</a>
          <a href="#experience" className="hover:text-cyan-400">{t.nav.experience}</a>
          <a href="#skills" className="hover:text-cyan-400">{t.nav.skills}</a>
  ...
  return (
    <LanguageContext.Provider value={{ lang, toggleLang, t }}>
      <div className="min-h-screen flex flex-col relative bg-[#0b0f19] text-slate-100 selection:bg-cyan-500/30 selection:text-cyan-300">
        <Navbar activeSection={activeSection} onOpenContact={handleOpenContact} onOpenCV={() => setShowCVModal(true)} />
